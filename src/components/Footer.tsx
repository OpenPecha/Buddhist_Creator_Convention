      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            {/* Links */}
            <div className="space-y-4">
              <h3 className="text-xl font-bold">Connect with Organiser</h3>
              <div className="space-y-2">
                ...
                <a href="https://www.instagram.com/dharmaduta.in/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary-light transition-colors">
